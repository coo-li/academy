...
<div class="space-y-6">
                           ...
                           class="flex items-center justify-between px-6 py-4 hover:bg-red-50 transition-colors group">
                            ...
                            <div class="flex items-center gap-6">
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500">{{ number_format($employee['ist_hours'], 1, ',', '.') }}h / {{ number_format($employee['soll_hours'], 1, ',', '.') }}h</p>
                                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div class="flex flex-wrap items-center gap-6 text-sm">
            <span class="font-medium text-gray-700">Ampel-Legende (Teamziele IST/SOLL):</span>
            <div class="flex items-center gap-2">
                <span class="w-3 h-3 rounded-full bg-green-500"></span>
                <span class="text-gray-600">&ge; 90% - Top Nutzung</span>
            </div>
            <div class="flex items-center gap-2">
                <span class="w-3 h-3 rounded-full bg-yellow-500"></span>
                <span class="text-gray-600">75-90% - Ziele nutzen!</span>
            </div>
            <div class="flex items-center gap-2">
                <span class="w-3 h-3 rounded-full bg-red-500"></span>
