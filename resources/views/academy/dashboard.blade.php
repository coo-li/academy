            ...
            <div class="card-tool-body">
                <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                    ...
                    <div class="flex items-center gap-4 flex-shrink-0">
                        ...
                        <div>
                            <div class="text-xs text-surface-500 uppercase tracking-wide">Aktuelle Karrierestufe</div>
            ...
            <div class="card-tool">
                <div class="card-tool-body">
                    <div class="empty-state">
                        ...
                        <div class="empty-state-description">Für deine aktuelle Karrierestufe sind noch keine Module hinterlegt.</div>
                    </div>
                </div>
            </div>
            @endif
